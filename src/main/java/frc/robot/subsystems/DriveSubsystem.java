...
{
    private final Drive _frontLeft = new Drive(
    ...
    private final Drive _frontRight = new Drive(
    ...
    private final Drive _backLeft = new Drive(
    ...
    private final Drive _backRight = new Drive(
    ...
    public void setDriveMotorState(SwerveModuleState[] state)
    {
